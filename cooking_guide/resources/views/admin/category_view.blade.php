                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap display responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{ url('/category')}} /<?php echo $value->cat_image ?>" height="50px" width="70px"></td> 
                      <td> 
                        @if($value->cat_status == 0)
                        <a href='{{ route("statuscategory") }}/<?php echo $value->cat_id ?>'>
                          ...
                          <a href='{{ route("statuscategory") }}/<?php echo $value->cat_id ?>'>
                            ...
                            @endif
                            <!-- edit -->
                            <button type="button" class="btn btn-success waves-effect waves-light btn-sm" data-toggle="modal" data-target="#a<?php echo $value->cat_id ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Edit</span> </button>
                            <a href='{{ route("deletecategory") }}/<?php echo $value->cat_id ?>'>
                      ...
                      <!-- The Modal -->
                      <div class="modal fade" id="a<?php echo $cat->cat_id ?>">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <form id="signupForm" action="{{ route('updatecategory')}}/<?php echo $cat->cat_id ?>" method="post" enctype="multipart/form-data">
                              ...
                              <div class="modal-body">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <select type="text" class="form-control" id="input-10" name="cat_name">
                                      @foreach($category as $value)
                                      <option name="cat_name" value="{{ $value->cat_name }}" {{ $cat->cat_id == $value->cat_id ? 'selected' : '' }}>{{ $value->cat_name }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="file" class="form-control" id="input-10" name="cat_image" value="{{ $cat->cat_image }}">
                                  </div>
                                </div>
                              </div>
                              <!-- Modal footer -->

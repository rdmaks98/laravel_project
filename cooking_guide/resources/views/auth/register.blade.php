            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('mono') ? ' has-error' : '' }}">
                            <label for="mono" class="col-md-4 control-label">Mobile No:</label>

                            <div class="col-md-6">
                                <input id="mono" type="text" class="form-control" name="mono" value="" required>

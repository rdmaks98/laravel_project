...
<section>
  <div class="hero-slider">
    <!-- slider item -->
    <div class="hero-slider-item bg-cover hero-section" style="background: url('{{ asset('assets/images/gallery/1-4.jpg') }}'); ">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">
            ...
            <a href="room-grid.html" class="" data-duration-in=".3" data-animation-in="zoomIn" data-delay-in=".4"><!-- more details --></a>
          </div>
        </div>
      </div>
    </div>
    <!-- slider item -->
    <div class="hero-slider-item bg-cover hero-section" style="background: url('{{ asset('assets/images/gallery/1-3.jpg') }}'); ">
      <div class="container">
        <div class="row justify-content-center">
    ...
    <!-- slider item -->
    <div class="hero-slider-item bg-cover hero-section" style="background: url(' {{ asset('assets/images/gallery/1-2.jpg') }}'); ">
      <div class="container">
        <div class="row justify-content-center">
    ...
    <!-- slider item -->
    <div class="hero-slider-item bg-cover hero-section" style="background: url('{{ asset('assets/images/gallery/1-7.jpg') }}'); ">
      <div class="container">
        <div class="row justify-content-center">
